"""
ArcReflex — Search Agent B
===========================
Reputation: 65  |  Price: $0.00022/query  |  Auction score: 2954

Standby search agent. Loses the auction to Search A (lower reputation-to-price ratio).
Takes over if Search A fails or is unavailable.

Auction math:
  Search A: (72 × 100) / 200 = 3600  ← wins
  Search B: (65 × 100) / 220 = 2954  ← loses, stands by
"""
...
async def search(body: dict):
    """
    Standby search agent. Slightly higher price, lower reputation.
    Takes over from Search A in failover scenarios.
    """
